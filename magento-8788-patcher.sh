...
Versions=("1.14.2.4" "1.14.2.3" "1.14.2.2" "1.14.2.1" "1.14.2.0" "1.14.1.0" "1.14.0.1" "1.14.0.0" "1.13.1.0" "1.13.0.2" "1.13.0.1" "1.13.0.0" "1.12.0.0" "1.12.0.1" "1.12.0.2" "1.11.2.0" "1.11.1.0" "1.11.0.2" "1.11.0.1" "1.11.0.0" "1.10.1.1" "1.10.1.0" "1.10.0.2" "1.10.0.1" "1.10.0.0" "1.9.1.1" "1.9.1.0" "1.9.0.0")
if [[ " ${Versions[@]} " =~ " ${MageVersion} " ]]; then
    echo 'Valid Version'
else
    echo 'Only the following Magento Versions are Supported: 1.14.2.4, 1.14.2.3, 1.14.2.2, 1.14.2.1, 1.14.2.0, 1.14.1.0, 1.14.0.1, 1.14.0.0, 1.13.1.0, 1.13.0.2, 1.13.0.1, 1.13.0.0, 1.12.0.0, 1.12.0.1, 1.12.0.2, 1.11.2.0, 1.11.1.0, 1.11.0.2, 1.11.0.1, 1.11.0.0, 1.10.1.1, 1.10.1.0, 1.10.0.2, 1.10.0.1, 1.10.0.0, 1.9.1.1, 1.9.1.0, 1.9.0.0'
fi
}
